...
function normalizeRecipientFilter(recipient) {
...
export const useNotificationsStore = defineStore("notifications", () => {
    ...
    const startedForRecipient = ref(null);
    let socket = null;
    const unreadCount = computed(() => items.value.filter((item) => String(item.status || "").toUpperCase() !== "READ").length);
    function sortItems() {
    ...
    async function start(recipient) {
