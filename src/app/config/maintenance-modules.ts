...
export const maintenanceModules: MaintenanceModuleConfig[] = [
  ...
  {
    key: "componentes-equipo",
    title: "Partes oficiales de equipos",
    endpoint: "/kpi_maintenance/componentes",
    fields: [
      { key: "equipo_id", label: "Equipo", type: "select", required: true, relation: { endpoint: "/kpi_maintenance/equipos" } },
      { key: "parent_id", label: "Parte padre", type: "select", relation: { endpoint: "/kpi_maintenance/componentes" } },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "compartimiento_codigo_referencia", label: "Codigo compartimiento", type: "text" },
      { key: "compartimiento_nombre_oficial", label: "Compartimiento oficial", type: "text" },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "detalles", label: "Detalle del análisis (JSON)", type: "json", jsonMode: "array" },
    ],
  },
  {
    key: "inteligencia-control-componentes",
    title: "Control de componentes críticos",
